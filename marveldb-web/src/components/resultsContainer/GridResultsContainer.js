...
class GridResultsContainer extends Component {
	constructor(props) {
		super(props);
		let state = {};
	...
	componentWillMount() {
		...
		if (!this.props.data[this.props.resultsType]) {
...
GridResultsContainer = connect(mapStateToProps, mapDispatchToProps)(GridResultsContainer);

export default GridResultsContainer;
